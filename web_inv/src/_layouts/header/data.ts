...
const pageLinks: LinkType[] = [
  ...
  {
    href: '/app/apps/kanban',
    title: 'Kanban App',
  },
  {
    href: '/app/apps/user-profile/profile',
  ...
  {
    href: '/app/apps/ecommerce/checkout',
    title: 'Shopping Cart',
  },
];
