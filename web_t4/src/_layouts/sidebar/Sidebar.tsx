    ...
    return (
        ...
        >
            ...
            <div className="px-6 flex items-center brand-logo overflow-hidden">
                <AMLogo component={Link} href="/app" img="">
                    <FullLogo />
                </AMLogo>
            </div>
                    ...
                    <div className="mt-9 overflow-hidden">
                        <div className="flex w-full bg-lightprimary rounded-lg p-6">
                            <div className="lg:w-1/2 w-full">
                                <h5 className="text-base text-sidebar-foreground">Mobile App</h5>
                                <Button className="whitespace-nowrap mt-2 text-[13px]">Get Android</Button>
                            </div>
