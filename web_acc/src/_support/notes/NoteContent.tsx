...
import { NotesContext, NotesContextType } from 'src/_support/notes/notes-context/index';
...
const NoteContent = () => {
  ...
  const [isEditing, setIsEditing] = useState(false); // State to track whether editing is open
