...
function THeader({ className, ...props }: React.ComponentProps<'thead'>) {
...
function TFooter({ className, ...props }: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot
...
function THead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
...
function TCaption({ className, ...props }: React.ComponentProps<'caption'>) {
  return (
    <caption
...
export { Table, THeader , TBody, TFooter, THead, TRow, TCell, TCaption };
